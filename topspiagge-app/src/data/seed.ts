...
export function buildArticles(): Article[] {
  return [
    ...
    { id: 'art-acqua', name: 'Acqua 0.5L', category: 'bar', basePrice: 1.5, unit: 'pz', stock: 60 },
    { id: 'art-caffe', name: 'Caffè', category: 'bar', basePrice: 1.2, unit: 'pz' },
    { id: 'art-spritz', name: 'Spritz', category: 'bar', basePrice: 6, unit: 'pz', stock: 4 },
    { id: 'art-panino', name: 'Panino', category: 'bar', basePrice: 5, unit: 'pz', stock: 15 },
